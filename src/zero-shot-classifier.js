...
class ZeroShotFieldClassifier {
  ...
  static ALL_LABELS = [
    ...
    "the person's current visa or immigration status",
    "whether the person has held a J-1 or J-2 exchange visitor visa",
    ...
    // Demographics (EEO) - More specific labels
    "a person's gender such as male or female",
    "whether the person is Hispanic or Latino",

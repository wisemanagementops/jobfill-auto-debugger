...
export class AIFormFiller {
  ...
  async fillClassifiedFields(classifications) {
    for (const { field, classification, context } of classifications) {
      ...
      else if ((fieldLabelLower.includes('phone number') && !fieldLabelLower.includes('code') && !fieldLabelLower.includes('country')) ||
               (fieldIdLower.includes('phonenumber') && !fieldIdLower.includes('countryphone') && !fieldIdLower.includes('phonecode'))) {
